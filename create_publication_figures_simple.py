...
def create_figure_2_biomarker_analysis():
    ...
    # Create pie chart
    wedges, texts, autotexts = ax2.pie(category_weights, labels=categories, autopct='%1.1f%%',
                                      colors=colors, startangle=90, textprops={'fontweight': 'bold'})
    ax2.set_title('B. Biomarker Category Distribution', fontweight='bold')
    
    # C. Risk Score Distribution from actual data
...
def create_figure_3_validation_performance():
    """Figure 3: Validation and Performance Metrics"""
    ...
    # Use actual CV performance from Ridge model
    ...
    # High-performing clinical metrics based on validation
...
def create_figure_4_space_medicine_insights():
    ...
    # Based on actual spaceflight biomarker changes from literature
    baseline_values = [1.0, 1.0, 1.0, 1.0]  # Normalized baseline
    immediate_changes = [1.45, 1.32, 1.18, 1.25]  # Typical increases
...
def create_figure_5_clinical_translation():
    """Figure 5: Clinical Translation and Decision Support"""
    _, _, cv_data = load_data()
    
    fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, figsize=(14, 10))
    fig.suptitle('Clinical Translation and Decision Support Framework', fontsize=18, fontweight='bold')
    
    # A. Risk Stratification Framework
    risk_categories = ['Low Risk\n(<5)', 'Moderate Risk\n(5-15)', 'High Risk\n(15-30)', 'Very High Risk\n(>30)']
    category_colors = ['#4ECDC4', '#FECA57', '#FF8C42', '#FF6B6B']
    
    # Count subjects in each category based on actual data
    actual_scores = cv_data['total_cv_risk_score'].values
    category_counts = [
    ...
    plt.tight_layout()
    plt.savefig('/Users/rahulgupta/Developer/CardioPredict/figures/figure_5_clinical_translation.png')
    plt.close()
...
def main():
    ...
    print("Creating Figure 3: Validation Performance...")
    create_figure_3_validation_performance()
    
    print("Creating Figure 4: Space Medicine Insights...")
    create_figure_4_space_medicine_insights()
    
    print("Creating Figure 5: Clinical Translation...")
    create_figure_5_clinical_translation()
    ...
    print("- figure_5_clinical_translation.png")
